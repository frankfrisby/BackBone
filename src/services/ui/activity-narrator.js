 ...
 * - Bash(cd "~/backbone/projects" && npm install)
 * - Grep("async function.*export" --include="*.js" ./src)
 * - Read(~/backbone/Documents/resume.md)
 * - Write(~/backbone/projects/notes.md)
...
export const ACTION_TOOLS = {
  ...
  READ: {
    ...
    category: "file",
    // Example: Read(~/backbone/Documents/resume.md)
  },
  ...
  WRITE: {
    ...
    category: "file",
    // Example: Write(~/backbone/projects/job_search.md)
  ...
  UPDATE: {
    ...
    category: "file",
    // Example: Update(~/backbone/projects/job_search.md)
  ...
  EDIT: {
    ...
    category: "file",
    // Example: Edit(~/backbone/src/auth.js)
  ...
  DELETE: {
    ...
    category: "file",
    // Example: Delete(~/backbone/temp/old_file.txt)
  },
  ...
  BASH: {
    ...
    category: "system",
    // Example: Bash(cd "~/backbone/projects" && npm start)
  ...
  MKDIR: {
    ...
    category: "system",
    // Example: MkDir(~/backbone/projects/job-search-dc)
  ...
  COPY: {
    ...
    category: "system",
    // Example: Copy(~/backbone/docs/template.md -> ~/backbone/projects/new.md)
  },
  ...
  MOVE: {
    ...
    category: "system",
    // Example: Move(~/backbone/downloads/file.pdf -> ~/backbone/docs/)
  },
  ...
  GLOB: {
    ...
    // Example: Glob(~/backbone/Documents/*.md)
  ...
  WEB_FETCH: {
    ...
    category: "web",
    // Example: Fetch(https://www.linkedin.com/in/username)
